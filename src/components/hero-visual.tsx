...
export function HeroVisual() {
  return (
    <div
      className="animate-hero-drift pointer-events-none absolute inset-0 overflow-hidden text-accent"
      aria-hidden="true"
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 20% 20%, var(--surface) 0%, transparent 55%), radial-gradient(ellipse at 85% 15%, var(--success-soft) 0%, transparent 45%), linear-gradient(160deg, var(--surface) 0%, var(--background) 48%, var(--surface) 100%)",
        }}
      />
      <svg
      ...
      >
        ...
        <g stroke="currentColor" strokeOpacity="0.18" strokeWidth="1.25">
