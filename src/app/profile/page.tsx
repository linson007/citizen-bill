...
export default async function ProfilePage() {
  ...
  return (
    <main className={`flex min-h-screen flex-col bg-background text-foreground ${ml ? "font-malayalam" : ""}`}>
      <SiteHeader />
      ...
      <section className="mx-auto max-w-7xl px-5 py-8 sm:px-8">
                  ...
                  <div className="mt-3 flex gap-2">
                    {item.bill ? (
                      <Link
                        ...
                        className="flex h-8 items-center rounded-md border border-border-strong px-2.5 text-xs font-semibold text-ink-soft"
                      >
                        {ml ? "തുടരുക" : "Continue"}
                      </Link>
                    ) : (
                    ...
                    <form action={deleteAiSessionAction}>
                      ...
                      <button
                        type="submit"
                        className="h-8 rounded-md border border-border-strong px-2.5 text-xs font-semibold text-danger"
                      >
                        {ml ? "നീക്കുക" : "Delete"}
                      </button>
                    </form>
        ...
        <section className="mb-6 rounded-lg border border-border bg-surface-raised p-5 shadow-sm">
