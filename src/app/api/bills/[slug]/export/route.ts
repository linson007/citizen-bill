...
export async function GET(
  ...
  if (format === "docx") {
    ...
    return new Response(body, {
      headers: {
        "Content-Disposition": `attachment; filename="${safeFileName(bill.slug)}.docx"`,
        "Content-Type":
  ...
  return new Response(body, {
    headers: {
      "Content-Disposition": `attachment; filename="${safeFileName(bill.slug)}.pdf"`,
...
function createDocx(lines: string[]) {
